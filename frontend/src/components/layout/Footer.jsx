            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
                    ...
                    <div className="lg:col-span-4">
                        ...
                        <div className="flex flex-col gap-3 w-full lg:w-auto">
                            <a
                                href="tel:+919567924716"
                                className="group flex items-center gap-4 p-3.5 rounded-xl bg-secondary-50 hover:shadow-gold transition-all duration-300"
                            >
                                <div className="w-9 h-9 rounded-lg bg-white flex items-center justify-center text-primary-500 group-hover:scale-110 transition-transform">
                                    <FiPhone size={18} />
                                </div>
                                <div>
                                    <p className="text-[10px] font-semibold text-primary-600 uppercase tracking-wider mb-0.5">Call Us</p>
                                    <span className="text-gray-900 font-medium text-sm group-hover:text-primary-700 transition-colors">+91 9567924716</span>
                                </div>
                            </a>
                            ...
                            >
                                ...
                                <div>
                                    <p className="text-[10px] font-semibold text-primary-600 uppercase tracking-wider mb-0.5">Email Us</p>
                                    <span className="text-gray-900 font-medium text-sm group-hover:text-primary-700 transition-colors">hello@glitzcreativez.com</span>
                                </div>
                            </a>

                            <div className="flex items-center gap-4 p-3.5 rounded-xl bg-secondary-50">
                                <div className="w-9 h-9 rounded-lg bg-white flex items-center justify-center text-primary-500">
                                    <FiMapPin size={18} />
                                </div>
                                <div>
                                    <p className="text-[10px] font-semibold text-primary-600 uppercase tracking-wider mb-0.5">Visit Us</p>
                                    <span className="text-gray-900 font-medium text-sm">New York, NY 10001</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-16 pt-8 border-t border-secondary-200 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-6 text-sm text-gray-400 font-medium">
                        ...
                        <Link to="/refund" className="hover:text-primary-600 transition-colors">Refund</Link>
                    </div>
                </div>
            </div>
        </footer>
